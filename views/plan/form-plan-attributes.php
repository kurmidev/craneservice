        ...
        <div class="card card-secondary">
            <div class="card-header">
                <div class="card-title">
                    <?=($model->isNewRecord ? "Add New Plan Attributes" : "Update {$model->name}")?>
                </div>
            </div>
            <div class="card-body">
                <?php $form = ActiveForm::begin(['id' => 'form-plan-attributes', 'options' => ['enctype' => 'mutipart/form-data', 'class' => 'form-horizontal form-bordered']]); ?>
